...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        echo "<p class='text-8F8073'>Permiso registrado correctamente.</p>";
    } else {
        echo "<p class='text-red-500'>Error al registrar permiso.</p>";
    }
}
?>
...
<body>
    <div class="container">
        <div class="header">Registrar Nuevo Permiso</div>
